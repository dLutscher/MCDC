...
import mcdc.utils.layers as layers
from mcdc.config import get_config
from mcdc.utils.engines import create_mcdc_trainer, create_idec_mcdc_finetuning_trainer, create_evaluator
from mcdc.utils.handlers import add_handlers
from mcdc.utils.data import get_data_loaders
from mcdc.utils.utils import *
from mcdc.utils.clustering import error, cluster, estimate_initial_centroids, inference_idec
...
def main(cfg):
    ...
    if cfg.MODEL.MODE.lower() in 'training':
        ...
        clust_trainer = create_idec_mcdc_finetuning_trainer(
            models=models_dict, cfg=cfg)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="PyTorch IDEC+MCDC training.")
    parser.add_argument(
        '-c',
        '--config_file',
        default=None,
