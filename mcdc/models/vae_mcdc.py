...
def main(cfg):
    ...
    if cfg.MODEL.MODE.lower() in 'training':
        ...
        trainer = create_vae_mcdc_trainer(models=models_dict, custom_loss=layers.custom_loss, cfg=cfg)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="PyTorch VAE+MCDC training.")
    parser.add_argument(
        '-c',
        '--config_file',
        default=None,
