...
from mcdc.utils.engines import create_mcdc_trainer, create_evaluator
...
def main(cfg):
    ...
    if cfg.MODEL.MODE.lower() in 'training':
        ...
        trainer = create_mcdc_trainer(models=models_dict,
                                      cfg=cfg)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="PyTorch MCDC training.")
    parser.add_argument(
        '-c',
        '--config_file',
        default=None,
